...
public class IncrementalUnifiedDependentCountingAlgorithmTest {
	...
	public void singleWedgeAddition() {
		...
		int size = 10;
		IncrementalUnifiedDependentCounting topk = new IncrementalUnifiedDependentCounting(size, size);
		topk.addEdge(a);
		topk.addEdge(b);
