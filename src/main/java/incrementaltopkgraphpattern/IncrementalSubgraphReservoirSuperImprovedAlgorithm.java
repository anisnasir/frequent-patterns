...
public class IncrementalSubgraphReservoirSuperImprovedAlgorithm implements TopkGraphPatterns {
	NodeMap nodeMap;
	EdgeHandler utility;
	...
	public IncrementalSubgraphReservoirSuperImprovedAlgorithm(int size, int k ) { 
